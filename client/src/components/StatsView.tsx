...
interface Props {
  data: Data,
  controlLiveDataStream: (isLive: boolean) => void
}

export const StatsView: React.FC<Props> = ({ data, controlLiveDataStream }) => {
  const [isLive, toggleIsLive] = useState<boolean>(false);
  return (
    <div className='stats-view-container'>
      <div className='stats-header'>
        ...
        <div className='live-toggle-container'>
          <p>LAST UPDATE: {moment().calendar(new Date(Number(data.RAW.LASTUPDATE) * 1000)).toUpperCase()}</p>
